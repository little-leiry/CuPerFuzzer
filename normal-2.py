...
def test():
    ...
    for group in groups:
        ...
        #install_apk_comb=['TEST-normal-NULL.apk','TEST-dangerous-NULL.apk','TEST-normal-NULL.apk']
        install_apk_comb = ['TEST-normal-NULL.apk', 'NULL-NUll-NULL.apk', 'TEST-dangerous-NULL.apk']
        #install_apk_comb = ['TEST-normal-NULL.apk', 'TEST-dangerous-' + group + '.apk']
        valid_case_num=oneTestNormal2(op_seq, install_apk_comb,device_id,valid_case_num)
    ...
    #apk1='E:/fuzzing/new/apk-1/TEST-dangerous-NULL.apk'
    #apk2='E:/fuzzing/new/simulateclick.apk'
    #uninstall('com.leiry.declared', device_id)
    #uninstall('com.leiry.simulateclick',device_id)
    #install(apk1,device_id)
    #install(apk2,device_id)
    #re=validCase2('com.leiry.declared','com.leiry.simulateclick',device_id)
    #print(re)
#test()


def test1():
    grant = validCase2("com.leiry.test", "com.leiry.test", "FA7B31A06070")
    print(grant)
#test1()